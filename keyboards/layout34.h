...
const struct KeycodeLayout layout = {
    ...
    { // Num
        {
            QK_BOOT,    XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  KC_PAST, KC_P7,  KC_P8,   KC_P9,   KC_PSLS
        },
        {
            XXXXXXX,    XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX,  KC_PPLS, KC_P4,  KC_P5,   KC_P6,   KC_PMNS
        },
        {
            LCTL(KC_Z), LCTL(KC_Y), XXXXXXX, XXXXXXX, XXXXXXX,  KC_EQL,  KC_P1,  KC_P2,   KC_P3,   KC_PDOT
        },
        {
                                             XXXXXXX,  XXXXXXX, KC_ENT, KC_P0  
        }
    },
    { // Nav / FN
        {
