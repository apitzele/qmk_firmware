...
#include "tapdancesMac.h"
#include "layout34Mac.h"
#include "oled.h"

// FLASH: qmk flash -kb crkbd -km apitzeleMac -e CONVERT_TO=promicro_rp2040
// COMPILE: qmk compile -kb crkbd -km apitzeleMac -e CONVERT_TO=promicro_rp2040
