...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [T_TAB] = ACTION_TAP_DANCE_TAP_AND_HOLD(KC_TAB, LSFT(KC_TAB)),
  ...
  [T_Z] = ACTION_TAP_DANCE_TAP_AND_HOLD(KC_Z, LCTL(KC_Z)),
  [T_Y] = ACTION_TAP_DANCE_TAP_AND_HOLD(KC_Y, RCTL(KC_Y)),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //,-------------------------------------------------------------------------.         ,----------------------------------------------------------------------.
    XXXXXXX, TD(T_Q),      TD(T_W),      TD(T_F),      KC_P,         KC_B,               KC_J, KC_L,         KC_U,         TD(T_Y),      KC_SCLN,      XXXXXXX,
 //|-------+-------------+-------------+-------------+-------------+---------|         |-----+-------------+-------------+-------------+-------------+--------|
 ...
 //|-------+-------------+-------------+-------------+-------------+---------|         |-----+-------------+-------------+-------------+-------------+--------|
    XXXXXXX, TD(T_Z),      TD(T_X),      TD(T_C),      TD(T_D),      TD(T_V),            KC_K, TD(T_H),      KC_COMM,      KC_DOT,       TD(T_SLASH),  XXXXXXX,
 //,-----------------------------------------------------------------------------|  |-------------------------------------------------------------------------.
  ...
  //|--------+--------+--------+--------+--------+--------|          |--------+--------+--------+--------+-------+--------|
      XXXXXXX, _______, _______, _______, _______, _______,            KC_PDOT, KC_P1,  KC_P2,   KC_P3,   KC_PEQL, XXXXXXX,
  //|----------------------------------------------------------|  |-------------------------------------------------------|
