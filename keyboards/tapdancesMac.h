...
void T_SLASH_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_HOLD: register_code16(RGUI(KC_SLASH)); break;
...
void T_SLASH_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_HOLD: unregister_code16(RGUI(KC_SLASH)); break;
...
tap_dance_action_t tap_dance_actions[] = {
        ...
        [T_W] = ACTION_TAP_DANCE_TAP_HOLD(KC_W, LGUI(KC_A)),
        [T_F] = ACTION_TAP_DANCE_TAP_HOLD(KC_F, LGUI(KC_F)),
        [T_Z] = ACTION_TAP_DANCE_TAP_HOLD(KC_Z, KC_TAB),
        [T_X] = ACTION_TAP_DANCE_TAP_HOLD(KC_X, LGUI(KC_X)),
        [T_C] = ACTION_TAP_DANCE_TAP_HOLD(KC_C, LGUI(KC_C)),
        [T_D] = ACTION_TAP_DANCE_TAP_HOLD(KC_D, LGUI(KC_S)),
        [T_V] = ACTION_TAP_DANCE_TAP_HOLD(KC_V, LGUI(KC_V)),
        [T_H] = ACTION_TAP_DANCE_TAP_HOLD(KC_H, LGUI(KC_H)),
