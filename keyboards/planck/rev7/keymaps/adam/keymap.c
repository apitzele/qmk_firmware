 ...
 * |------+--------+------+------+------+------+------+------+------+------+------+---------|
 * | Caps-Word | Ctrl | Alt  | Esc  |Lower |    Space    |Raise | Left |  Up  |Down  |Right |
 * `----------------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_mit(
    ...
    CW_TOGG, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   LT(LOWER, KC_SPC),        LT(RAISE, KC_ENT), KC_LEFT,  KC_UP,  KC_DOWN,  KC_RGHT
),
