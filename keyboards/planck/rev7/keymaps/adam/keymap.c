...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    _______,      _______,      _______,       KC_BSPC,         LSFT_T(KC_SPC), _______, _______,    RSFT_T(KC_ENT), TD(TD_TAB),      _______,      _______,      _______
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_BSPC, LSFT_T(KC_SPC), _______, _______, RSFT_T(KC_DEL), KC_CAPS,          _______, _______, _______
),
...
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_BSPC, LSFT_T(KC_SPC), _______, _______,    KC_P0,   TD(TD_TAB), _______, _______, _______
),
