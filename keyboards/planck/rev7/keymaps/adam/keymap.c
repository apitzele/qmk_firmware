...
combo_t key_combos[COMBO_COUNT] = {
  [Z_T_MT] = COMBO(z_t_mt, MT(MOD_LCTL, KC_Z)),
  [Z_X_MT] = COMBO(z_x_mt, MT(MOD_LCTL, KC_X)),
  [A_T_MT] = COMBO(a_t_mt, MT(MOD_LCTL, KC_A)),
  [X_C_MT] = COMBO(x_c_mt, MT(MOD_LCTL, KC_C)),
  [D_V_MT] = COMBO(d_v_mt, MT(MOD_LCTL, KC_V)),
  [R_S_MT] = COMBO(r_s_mt, MT(MOD_LCTL, KC_S)),
  [W_F_MT] = COMBO(w_f_mt, MT(MOD_LCTL, KC_F)),
  [S_T_MT] = COMBO(s_t_mt, MT(MOD_LCTL, KC_T)),
  [T_G_MT] = COMBO(t_g_mt, MT(MOD_LCTL, KC_G)),
  [M_N_MT] = COMBO(m_n_mt, MT(MOD_LCTL, KC_N))
};
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_EQL,  KC_PLUS, KC_MINS, KC_UNDS, CW_TOGG, _______, _______, _______, KC_LCBR, KC_RCBR, KC_GRV,  KC_QUOT,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_PIPE, KC_BSLS,
